...
def run_ec_ppo_with_tune(jsp_instance: np.ndarray, jsp_instance_details: Dict) -> None:
...
def run_ec_ppo_with_trainer(jsp_instance: np.ndarray, jsp_instance_details: Dict) -> None:
    config = ppo.DEFAULT_CONFIG.copy()
    config["env"] = "GraphJsp-v0"
    config["env_config"] = {
        "jps_instance": jsp_instance,
...
if __name__ == '__main__':
    ...
    run_ec_ppo_with_tune(instance, details_dict)
    # run_ec_ppo_with_trainer(instance, details_dict)
