...
class MuZeroConfig:
    def __init__(self):
        ...
        # Fix the maximum number of GPUs to use. It's usually faster to use a single GPU (set it to 1)
        # if it has enough memory. None will use every GPUs available
        self.max_num_gpus = None

        # Game
        # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array,
        # please reshape it to (1, 1, length of array)
        ...
        # Prioritized Replay (See paper appendix Training), select in priority the elements in the
        # replay buffer which are unexpected for the network
        self.PER = True
