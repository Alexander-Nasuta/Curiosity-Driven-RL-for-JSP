...
def run_dynamic_ppo_icm_jss_experiment(total_timesteps: int, n_jobs: int, n_machines: int, *,
    ...
    model_config = {
        ...
        "model_hyper_parameters": {
            ...
            "policy_kwargs": {
                "net_arch": [{
                    "pi": [90, 90, 90, 90, 90, 90, 90, 90, 90],
                    "vf": [90, 90, 90, 90, 90, 90, 90, 90, 90],
                }],
                "ortho_init": True,
...
if __name__ == '__main__':
    ...
    run_dynamic_ppo_icm_jss_experiment(
