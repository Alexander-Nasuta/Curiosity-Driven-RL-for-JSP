...
def generate_jsp_instance(n_jobs: int = 3, n_machines: int = 4,
    ...
    save_dir = PATHS.JSP_INSTANCES_CUSTOM_PATH.joinpath(f"{n_jobs}x{n_machines}")
...
def generate_jsp_instances(n_instances: int = 100, n_jobs: int = 3, n_machines: int = 3,
    ...
    log.info("updating details file...")
    details.update_custom_instance_details()
